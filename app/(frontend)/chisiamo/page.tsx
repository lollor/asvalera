...
export default function Page() {
    return (
        <div className="sezione">
            ...
            <div className="mt-3 gap-3 max-sm:space-y-3 lg:grid grid-cols-2">
                <div className="aspect-[4/3] w-full relative shadow-2xl rounded">
                    <Image src={bambini1} placeholder="blur" fill className=" object-cover " alt="Bambini" />
                </div>
                <div className="aspect-[4/3] w-full relative shadow-2xl rounded">
                    <Image src={trapattoni} placeholder="blur" fill className=" object-cover " alt="Trapattoni" />
                </div>
            </div>
        </div>
    )
